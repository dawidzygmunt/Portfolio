...
export const Projects = () => {
  return (
    <div id='Projects' className='container mx-auto'>
      <div className='text-white px-6 md:px-14 text-center flex flex-col items-center'>
        <span className='text-center text-6xl font-extrabold text-white py-6'>
          Projects
        </span>
        <p className='text-slate-300 lg:px-52 text-center text-lg pb-7'>
